...
FILE_DA_CONSEGNARE=Makefile chatty.c message.h ops.h stats.h config.h \
		   DATA/chatty.conf1 DATA/chatty.conf2 connections.h \
		    client.c coda.c coda.h configurazione.c configurazione.h \
		   connections.c hash.c hash.h messaggi.c messaggi.h \
		   server.c server.h threadpool.c threadpool.h \
		   script.sh testconf.sh testfile.sh testleaks.sh teststress.sh Relazione.pdf
...
#
###################################################################
UNIX_PATH       = /tmp/chatty_socket_518136
STAT_PATH       = /tmp/chatty_stats_518136.txt
DIR_PATH        = /tmp/chatty_518136
